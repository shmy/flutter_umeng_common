#import "FlutterUmengCommonPlugin.h"
...
@implementation FlutterUmengCommonPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"flutter_umeng_common"
            binaryMessenger:[registrar messenger]];
  FlutterUmengCommonPlugin* instance = [[FlutterUmengCommonPlugin alloc] init];
